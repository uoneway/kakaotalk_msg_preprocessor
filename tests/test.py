...
if __name__ == '__main__':
    for file_path in file_path_list:
        ...
        file_type = kakaotalk_msg_tokenizer.check_export_file_type(file_path)
        print(file_type)
        
        messages = kakaotalk_msg_tokenizer.msg_tokenizer(file_type, file_path)
        print(messages)

        url_messages = kakaotalk_msg_tokenizer.url_msg_extractor(file_type, messages)
        print(url_messages)
